...
export output_scores_folder="${clinical_output_score_folder_indels}${output_folder_override}"
export msa_folder=${PROTEINGYM_CACHE}/baselines/PoET/msas/clinical_indels
...
export DMS_index="${DMS_index:-"variant index to run (e.g. 0,1,...1554)"}"
